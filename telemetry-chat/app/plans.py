"""Pydantic models for the agent's structured plan output.

Standalone — no `app.*` imports — so the file is portable to other services
(notably telemetry-comparison) once they adopt the same agent contract.
"""
