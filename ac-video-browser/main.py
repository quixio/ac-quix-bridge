...
def _get_blob_fs():
    ...
    client_kwargs={"verify": False} for MinIO deployments fronted by a
    self-signed cert chain (quixportal 2.0.1 has no knob for this). Falls
    back to quixportal.get_filesystem() when the JSON env var is unset."""
