...
export default function AddTestPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault()
    if (!experimentId.trim() || !pcDeviceId || !testRigDeviceId || !environmentId || !driver) return
  ...
  const isFormValid = experimentId.trim() && pcDeviceId && testRigDeviceId && environmentId && driver
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Select value={testRigDeviceId} onValueChange={setTestRigDeviceId}>
                  <SelectTrigger>
