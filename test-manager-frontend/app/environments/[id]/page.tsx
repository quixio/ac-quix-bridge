...
export default function EnvironmentDetailPage() {
  ...
  if (loading) {
    return (
      <MainLayout
        backLink={{ href: "/environments", label: "Back to Environments" }}
      >
    ...
    return (
      ...
      >
        <EmptyState
          ...
          description={
            error?.message || "The requested environment could not be found."
          }
          action={{
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <Button
              variant="outline"
              size="sm"
              onClick={() => router.push(`/environments/${environmentId}/edit`)}
            >
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    ...
                    {environmentId})? This action cannot be undone.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
