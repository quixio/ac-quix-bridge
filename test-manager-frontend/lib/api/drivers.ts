...
import type { Driver, DriverCreate, DriverUpdate, DriverQuery } from "@/types/driver"
...
export const driversApi = {
  list: (
    ...
    return apiGet<PaginatedResponse<Driver>>("/drivers", params, token, refreshToken)
  },
  ...
  get: (
    ...
    return apiGet<Driver>(`/drivers/${driverId}`, undefined, token, refreshToken)
  },
