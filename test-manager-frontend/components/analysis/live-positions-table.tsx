...
// Duration (ms) of the synchronized blue-freeze window after a gate crossing.
// Override via build-time env var `NEXT_PUBLIC_FREEZE_MS` (must be prefixed
// `NEXT_PUBLIC_` so Next bakes it into the client bundle).
